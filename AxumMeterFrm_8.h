...
#ifndef AxumMeterFrm8H
#define AxumMeterFrm8H
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TAxumMeterForm_8 : public TMambaNetForm
{
...
public:     // User declarations
  ...
  unsigned char OffColor[54];
   __fastcall TAxumMeterForm_8(TComponent* Owner, char *url, char *port, char TCP, form_node_info *node_info);
   __fastcall ~TAxumMeterForm_8();
...
//---------------------------------------------------------------------------
extern PACKAGE TAxumMeterForm_8 *AxumMeterForm_8;
//---------------------------------------------------------------------------
#endif
