...
TAxum4FBPForm_1 *Axum4FBPForm_1;
...
//---------------------------------------------------------------------------
__fastcall TAxum4FBPForm_1::TAxum4FBPForm_1(TComponent* Owner, char *url, char *port, char TCP, form_node_info *node_info)
   : TMambaNetForm(Owner)
{
...
__fastcall TAxum4FBPForm_1::~TAxum4FBPForm_1()
{
  if (mbn != NULL)
    mbnFree(mbn);
}

void __fastcall TAxum4FBPForm_1::SwitchMouseDown(TObject *Sender,
...
void __fastcall TAxum4FBPForm_1::SwitchMouseUp(TObject *Sender,
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
  int ModuleNr, SwitchNr;
  char tempText[32];
...
TPicture *TAxum4FBPForm_1::GetSmallSwitchPicture(unsigned char Color)
{
...
TPicture *TAxum4FBPForm_1::GetLargeSwitchPicture(unsigned char Color)
{
  TPicture *SwitchPicture;
...
void TAxum4FBPForm_1::UpdateSwitch(unsigned char ModuleNr, unsigned char SwitchNr)
{
  char ObjectName[32];
...
void TAxum4FBPForm_1::MambaNetError(int code, char *msg) {
}

void TAxum4FBPForm_1::MambaNetOnlineStatus(unsigned long addr, char valid) {
...
int TAxum4FBPForm_1::MambaNetSetActuatorData(unsigned short object, union mbn_data data)
{
...
void __fastcall TAxum4FBPForm_1::Encoder_DownMouseDown(TObject *Sender,
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
  int ModuleNr;
  char tempText[32];
...
void __fastcall TAxum4FBPForm_1::Encoder_ResetMouseDown(TObject *Sender,
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
  int ModuleNr;
  char tempText[32];
...
void __fastcall TAxum4FBPForm_1::Encoder_ResetMouseUp(TObject *Sender,
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
  int ModuleNr;
  char tempText[32];
...
void __fastcall TAxum4FBPForm_1::FaderPanelMouseMove(TObject *Sender,
...
void __fastcall TAxum4FBPForm_1::FaderPanelMouseDown(TObject *Sender,
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
  int ModuleNr;
  char tempText[32];
...
void __fastcall TAxum4FBPForm_1::FaderPanelMouseUp(TObject *Sender,
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
  int ModuleNr;
  char tempText[32];
...
void TAxum4FBPForm_1::CalculateFontSizes()
{
  int cntModule;
  int cntLine;
  char ObjectName[32];
...
void __fastcall TAxum4FBPForm_1::FormResize(TObject *Sender)
{
  int cntLine;
  int cntModule;
  int cntSwitch;
...
void __fastcall TAxum4FBPForm_1::SwitchLabelMouseDown(TObject *Sender,
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
  int ModuleNr, SwitchNr;
  char tempText[32];
...
void __fastcall TAxum4FBPForm_1::SwitchLabelMouseUp(TObject *Sender,
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
  int ModuleNr, SwitchNr;
  char tempText[32];
...
void TAxum4FBPForm_1::ConfigurationInformation(unsigned short object, char func_type, int func_seq, int func_nr, char *Label, char *Description)
{
  int ModuleNr;
  int SwitchNr;
  int LedNr;
...
void TAxum4FBPForm_1::StartCommunication()
{
  char err[MBN_ERRSIZE];
...
void TAxum4FBPForm_1::PrintLabels(TCanvas *Canvas, float *xMm, float *yMm, float xPixelPerMm, float yPixelPerMm, float PageWidthMm, float PageHeightMm)
{
  char CustomText[256];
...
bool TAxum4FBPForm_1::PrintLabelsAvailable()
{
  return true;
}
