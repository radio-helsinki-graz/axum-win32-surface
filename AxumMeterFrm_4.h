...
#ifndef AxumMeterFrm4H
#define AxumMeterFrm4H
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TAxumMeterForm_4 : public TMambaNetForm
{
...
public:     // User declarations
  ...
  unsigned char OffColor[54];
   __fastcall TAxumMeterForm_4(TComponent* Owner, char *url, char *port, char TCP, form_node_info *node_info);
   __fastcall ~TAxumMeterForm_4();
...
//---------------------------------------------------------------------------
extern PACKAGE TAxumMeterForm_4 *AxumMeterForm_4;
//---------------------------------------------------------------------------
#endif
