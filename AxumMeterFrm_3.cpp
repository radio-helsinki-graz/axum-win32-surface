...
TAxumMeterForm_3 *AxumMeterForm_3;
   ...
   : TMambaNetForm(Owner)
{
  ...
  thisnode.FirmwareMajorRevision = 3;
  ...
  objects[cntObject++] = MBN_OBJ( (char *)"Meter 3 Label",
                                  MBN_DATATYPE_NODATA,
                                  MBN_DATATYPE_OCTETS, 8, 0, 127, 20, "Meter 3");
  ...
  objects[cntObject++] = MBN_OBJ( (char *)"Meter 4 Label",
                                  MBN_DATATYPE_NODATA,
                                  MBN_DATATYPE_OCTETS, 8, 0, 127, 20, "Meter 4");
  objects[cntObject++] = MBN_OBJ( (char *)"Main/Clock Label",
                                  MBN_DATATYPE_NODATA,
                                  MBN_DATATYPE_OCTETS, 8, 0, 127, 20, "Main label");
...
__fastcall TAxumMeterForm_3::~TAxumMeterForm_3()
{
  if (mbn != NULL)
    mbnFree(mbn);
}
...
int TAxumMeterForm_3::MambaNetSetActuatorData(unsigned short object, union mbn_data data)
{
...
void __fastcall TAxumMeterForm_3::FormResize(TObject *Sender)
{
  char ObjectName[32];
  TLabel *DisplayLabel;
...
void TAxumMeterForm_3::ConfigurationInformation(unsigned short object, char func_type, int func_seq, int func_nr, char *Label, char *Description)
{
}

void TAxumMeterForm_3::StartCommunication()
{
  char err[MBN_ERRSIZE];
