...
__fastcall TAxumCRMForm_1::~TAxumCRMForm_1()
{
  if (mbn != NULL)
    mbnFree(mbn);
}

void __fastcall TAxumCRMForm_1::SwitchMouseDown(TObject *Sender,
...
void __fastcall TAxumCRMForm_1::SwitchMouseUp(TObject *Sender,
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
  int SwitchNr;
  char tempText[32];
...
TPicture *TAxumCRMForm_1::GetSmallSwitchPicture(unsigned char Color)
{
...
void TAxumCRMForm_1::UpdateSwitch(unsigned char SwitchNr)
{
  char ObjectName[32];
...
int TAxumCRMForm_1::MambaNetSetActuatorData(unsigned short object, union mbn_data data)
{
...
void __fastcall TAxumCRMForm_1::Encoder_DownMouseDown(TObject *Sender,
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
  if ((Button == Controls::mbLeft) && (Valid))
  {
...
void __fastcall TAxumCRMForm_1::Encoder_ResetMouseUp(TObject *Sender,
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
  if ((Button == Controls::mbLeft) && (Valid))
  {
...
void __fastcall TAxumCRMForm_1::PotentioMeter1KnobMouseMove(TObject *Sender,
...
void __fastcall TAxumCRMForm_1::FormResize(TObject *Sender)
{
  int cntSwitch;
  char ObjectName[32];
  TLabel *DisplayLabel;
...
void TAxumCRMForm_1::ConfigurationInformation(unsigned short object, char func_type, int func_seq, int func_nr, char *Label, char *Description)
{
  int SwitchNr;
  char ObjectName[32];
  int MaxFontSize;
...
void TAxumCRMForm_1::StartCommunication()
{
  char err[MBN_ERRSIZE];
...
void __fastcall TAxumCRMForm_1::LabelMouseDown(TObject *Sender,
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
  int SwitchNr;
  char tempText[32];
...
void __fastcall TAxumCRMForm_1::LabelMouseUp(TObject *Sender,
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
  int SwitchNr;
  char tempText[32];
...
void TAxumCRMForm_1::CalculateFontSizes()
{
  int cntSwitch;
  char ObjectName[32];
  TLabel *DisplayLabel;
...
void TAxumCRMForm_1::PrintLabels(TCanvas *Canvas, float *xMm, float *yMm, float xPixelPerMm, float yPixelPerMm, float PageWidth, float PageHeight)
{
...
bool TAxumCRMForm_1::PrintLabelsAvailable()
{
  return true;
}
