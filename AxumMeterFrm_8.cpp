...
TAxumMeterForm_8 *AxumMeterForm_8;
...
//---------------------------------------------------------------------------
__fastcall TAxumMeterForm_8::TAxumMeterForm_8(TComponent* Owner, char *url, char *port, char TCP, form_node_info *node_info)
   : TMambaNetForm(Owner)
{
  ...
  thisnode.FirmwareMajorRevision = 8;
...
__fastcall TAxumMeterForm_8::~TAxumMeterForm_8()
{
  if (mbn != NULL)
    mbnFree(mbn);
}

void TAxumMeterForm_8::MambaNetError(int code, char *msg) {
}

void TAxumMeterForm_8::MambaNetOnlineStatus(unsigned long addr, char valid) {
...
int TAxumMeterForm_8::MambaNetSetActuatorData(unsigned short object, union mbn_data data)
{
...
void __fastcall TAxumMeterForm_8::FormResize(TObject *Sender)
{
  char ObjectName[32];
  TLabel *DisplayLabel;
...
//---------------------------------------------------------------------------
void __fastcall TAxumMeterForm_8::MeterReleaseTimerTimer(TObject *Sender)
{
...
void TAxumMeterForm_8::ConfigurationInformation(unsigned short object, char func_type, int func_seq, int func_nr, char *Label, char *Description)
{
}

void TAxumMeterForm_8::StartCommunication()
{
  char err[MBN_ERRSIZE];
