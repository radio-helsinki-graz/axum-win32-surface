...
TAxumMeterForm_4 *AxumMeterForm_4;
...
//---------------------------------------------------------------------------
__fastcall TAxumMeterForm_4::TAxumMeterForm_4(TComponent* Owner, char *url, char *port, char TCP, form_node_info *node_info)
   : TMambaNetForm(Owner)
{
  ...
  thisnode.FirmwareMajorRevision = 4;
...
__fastcall TAxumMeterForm_4::~TAxumMeterForm_4()
{
  if (mbn != NULL)
    mbnFree(mbn);
}

void TAxumMeterForm_4::MambaNetError(int code, char *msg) {
}

void TAxumMeterForm_4::MambaNetOnlineStatus(unsigned long addr, char valid) {
...
int TAxumMeterForm_4::MambaNetSetActuatorData(unsigned short object, union mbn_data data)
{
...
void __fastcall TAxumMeterForm_4::FormResize(TObject *Sender)
{
  char ObjectName[32];
  TLabel *DisplayLabel;
...
//---------------------------------------------------------------------------
void __fastcall TAxumMeterForm_4::MeterReleaseTimerTimer(TObject *Sender)
{
...
void TAxumMeterForm_4::ConfigurationInformation(unsigned short object, char func_type, int func_seq, int func_nr, char *Label, char *Description)
{
}

void TAxumMeterForm_4::StartCommunication()
{
  char err[MBN_ERRSIZE];
